        ...
        <aside className="studio-preview-left">
          ...
          <div className="studio-preview-card open compact">
            ...
            <div className="studio-preview-colors">
              {["#ffffff", "#111712", "#ec2b91", "#2f6bff", "#16bfe8", "#ff744f"].map((color) => (
      ...
      <style jsx global>{`
        .home-loading-shell {
          ...
          background:
            ...
            radial-gradient(circle at 12% 12%, rgba(34, 184, 230, 0.09), transparent 28%),
  ...
  return (
    <style jsx global>{`
      ...
      .home-shell {
        ...
        color: #f4f5f7;
        background:
          radial-gradient(1100px 620px at 84% -10%, rgba(47, 107, 255, 0.26), transparent 60%),
          radial-gradient(900px 520px at 6% 8%, rgba(34, 184, 230, 0.12), transparent 58%),
      ...
      .home-brand strong {
        ...
        background: linear-gradient(135deg, #7db1ff 0%, #c08bff 45%, #4fd0ea 100%);
      ...
      .trial-button {
        color: white;
        background: linear-gradient(135deg, #2f6bff 0%, #2f8fff 46%, #22b8e6 100%);
        box-shadow: 0 18px 46px rgba(47, 107, 255, 0.4);
      }

      .trial-button:hover {
        box-shadow: 0 22px 54px rgba(47, 107, 255, 0.55);
      ...
      .hero-copy h1 span {
        color: transparent;
        background: linear-gradient(100deg, #2f6bff, #22b8e6 45%, #2f8fff 82%);
        -webkit-background-clip: text;
        background-clip: text;
      }
      ...
      .studio-preview-stage {
        ...
        place-items: center;
        border-radius: 30px;
        background: linear-gradient(135deg, #2f6bff 0%, #22b8e6 52%, #2f6bff 100%);
        box-shadow:
      ...
      .preview-brand span {
        ...
        border-radius: 7px;
        color: #fff;
        background: linear-gradient(135deg, #2f6bff, #22b8e6 54%, #2f6bff);
        font-size: 10px;
        font-weight: 900;
      }
      ...
      .preview-stage {
        ...
        background:
          ...
          linear-gradient(135deg, #2f6bff 0%, #22b8e6 50%, #2f6bff 100%);
      ...
      .toggle-row b {
        ...
        height: 20px;
        border-radius: 999px;
        background: linear-gradient(135deg, #2f6bff, #77f2c2);
      }
      ...
      .pricing-section {
        ...
        background:
          ...
          radial-gradient(circle at 94% 10%, rgba(47, 107, 255, 0.22), transparent 34%),
      ...
      .showcase-card div {
        ...
        overflow: hidden;
        border-radius: 17px;
        background: linear-gradient(135deg, #2f6bff, #22b8e6 52%, #2f6bff);
      }
      ...
      .showcase-card:nth-child(5) div { background: linear-gradient(135deg, #08090a, #22b8e6); }
      ...
      .plan-card a {
        ...
        border-radius: 15px;
        color: white;
        background: linear-gradient(135deg, #2f6bff 0%, #22b8e6 55%, #2f6bff 100%);
        box-shadow: 0 18px 46px rgba(47, 107, 255, 0.22);
        text-decoration: none;
        font-size: 15px;
        font-weight: 900;
      }
      ...
      .home-shell {
        ...
        --home-accent: linear-gradient(135deg, #2f6bff 0%, #2f8fff 46%, #22b8e6 100%);
        color: var(--home-text);
        background:
          radial-gradient(1100px 620px at 84% -10%, rgba(47, 107, 255, 0.24), transparent 60%),
          radial-gradient(900px 520px at 8% 10%, rgba(34, 184, 230, 0.1), transparent 58%),
          linear-gradient(180deg, #0b0d0f 0%, #090a0c 100%);
        font-size: 15px;
        line-height: 1.55;
      }
      ...
      .hero-copy h1 span {
        background: linear-gradient(100deg, #ffffff, #a9d4ff 46%, #86e4f5);
        -webkit-background-clip: text;
        background-clip: text;
      }
      ...
      .preview-stage {
        background:
          ...
          linear-gradient(135deg, #241a3d 0%, #2f6bff 52%, #22b8e6 100%);
      }

      .showcase-card div {
        background: linear-gradient(135deg, #241a3d 0%, #2f6bff 52%, #22b8e6 100%);
      }
